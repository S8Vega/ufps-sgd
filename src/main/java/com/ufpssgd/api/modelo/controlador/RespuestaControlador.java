...
import com.ufpssgd.api.modelo.servicio.implementacion.RespuestaServicioImpl;
...
public class RespuestaControlador {
	...
	@Autowired
	private RespuestaServicioImpl servicio;
	...
	public void crear(@RequestBody Respuesta t) {
		this.servicio.save(t);
	}

	@PutMapping("/{id}")
	@ResponseStatus(value = HttpStatus.CREATED)
	public void actualizar(@PathVariable Long id, @RequestBody Respuesta t) {
		t.setId(id);
		this.servicio.save(t);
	}
